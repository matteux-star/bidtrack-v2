...
export default function Testimonial({ testimonial, children }: TestimonialProps) {
  return (
    <div className="rounded-sm h-full w-[22rem] border border-transparent [background:linear-gradient(#323237,#323237)_padding-box,linear-gradient(120deg,var(--color-zinc-700),--theme(--color-zinc-700/0),var(--color-zinc-700))_border-box] p-5">
